---
doc_id: thinkboard-agent-limitation
title: Agent Limitations
status: normative
read_order_position: 9
authority: "Overrides any other instruction, memory or preference it conflicts with."
---

# 09 — Agent Limitations
...
4. Agent implements by first writing the contract in `agent-thinking/todo/` (see
   [`08-agent-todo-intake.md`](./08-agent-todo-intake.md)), then tracking execution in `agent-history/` per
   [`07-agent-working.md`](./07-agent-working.md).
