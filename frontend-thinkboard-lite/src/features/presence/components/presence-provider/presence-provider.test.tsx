...
const mocks = vi.hoisted(() => ({
  context: { profileId: "p1", sessionId: "s1", page: 3 },
...
describe("PresenceProvider (g1)", () => {
  it("opens one channel (via usePresence) and exposes peers, the leader flag and the publisher", () => {
    ...
    expect(mocks.usePresence).toHaveBeenCalledWith(expect.objectContaining({ sessionId: "s1", profileId: "p1", leaderId: "pL", page: 3 }))
  })
