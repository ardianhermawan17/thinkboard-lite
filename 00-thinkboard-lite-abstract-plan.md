# ThinkBoard **Lite** — abstract plan · revision 2
...
⚠️ This replaces the starting `task_sequence` in `02-working.md` §8. Full's 001–012 renumber to ≥015 when
...
| D5 | Does the Lite backlog replace `02-working.md` §8? | yes, proposed |
...
- ThinkBoard Full, in repo: `00-thinkboard-abstract-plan.md`, `01-thinkboard-schema-rationale.md`,
  `02-working.md`, `03-backend-folder-architecture.md`, `04-TODO.md`, `05-agent-limitation.md`,
