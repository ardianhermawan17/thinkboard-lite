...
companion: ['frontend-architecture.md', 'thinkboard-lite-frontend.html']
---

# Frontend Folder Architecture — ThinkBoard Lite
...
> general law and this one records where the instance differs. `frontend-architecture.md` explains _why_.
...
`06-thinkboard-lite.md` §4.2, not by this document.
