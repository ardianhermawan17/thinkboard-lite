...
version: "2.1"
status: proposed
supersedes: ["00-thinkboard-lite-abstract-plan.md rev 1", "00-thinkboard-lite-abstract-plan.md rev 2"]
read_order_position: 6
authority: "Product intent for Lite. Process stays in 02-working.md. Product intent for Full stays in 00-thinkboard-abstract-plan.md."
companion_artifacts:
...
# ThinkBoard Lite — consolidated spec (rev 2.1)
...
| **On conflict** | `thinkboard-schema-final.sql` wins on schema shape. `02-working.md` wins on process. This file wins on Lite product intent. `00-thinkboard-abstract-plan.md` wins on Full product intent. |
...
Replaces the starting `task_sequence` in `02-working.md` §8 (see D-05). One folder per task under
...
| D-05 | Does this backlog replace `02-working.md` §8? | yes, proposed |
...
- In repo: `00-thinkboard-abstract-plan.md`, `01-thinkboard-schema-rationale.md`, `02-working.md`, `03-backend-folder-architecture.md`, `04-TODO.md`, `05-agent-limitation.md`, `thinkboard-schema-final.sql`
