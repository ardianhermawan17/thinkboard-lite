...
companion: ["frontend-folder-architecture.md", "thinkboard-lite-frontend.html"]
---

# Frontend Architecture — ThinkBoard Lite
...
>
> Read `06-thinkboard-lite.md` first for product intent. This file governs the frontend only.
