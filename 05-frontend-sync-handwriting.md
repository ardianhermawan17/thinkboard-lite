...
version: "2.0"
read_order_position: 5
status: proposed
supersedes: "03-frontend-architecture.md §6.5 (handwriting)"
extends: ["03-frontend-architecture.md", "04-frontend-folder-architecture.md"]
companion: v2-handwriting-and-sync.html
---

# 05 — Frontend v2: Dexie ⇄ Supabase sync, and handwriting restructured
